...
addProductBtn.addEventListener("click", function () {
  ...
  if (rowCount < 60) {
    ...
    cell5.innerHTML = `<i class='bx bx-lg bxs-trash bx-tada-hover' style='color:#ff0202; cursor:pointer; display: flex; justify-content: center; align-items: center;'></i>`;
...
const deleteBtns = document.getElementsByClassName("bx-tada-hover");
